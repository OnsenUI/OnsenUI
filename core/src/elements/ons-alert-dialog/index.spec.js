...
describe('OnsAlertDialogElement', () => {
  ...
  it('exists', () => {
    expect(window.ons.elements.AlertDialog).to.be.ok;
  });
  ...
  describe('#registerAnimator()', () => {
    it('throws an error if animator is not a DialogAnimator', () => {
      expect(() => window.ons.elements.AlertDialog.registerAnimator('hoge', 'hoge')).to.throw(Error);
    });

    it('registers a new animator', () => {
      class MyAnimator extends window.ons.elements.AlertDialog.AlertDialogAnimator {
      }
      window.ons.elements.AlertDialog.registerAnimator('hoge', MyAnimator);
    });
  });
