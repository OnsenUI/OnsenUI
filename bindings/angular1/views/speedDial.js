...
(function() {
  ...
  module.factory('SpeedDialView', function($onsen) {
    ...
    var SpeedDialView = Class.extend({
      ...
      init: function(scope, element, attrs) {
        ...
        this._clearDerivingMethods = $onsen.deriveMethods(this, element[0], [
          'show', 'hide', 'showItems', 'hideItems', 'isOpen', 'toggle', 'toggleItems'
        ]);
    ...
    $onsen.derivePropertiesFromElement(SpeedDialView, [
      'disabled', 'visible', 'inline'
    ]);
