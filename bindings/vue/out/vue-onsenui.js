...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.OnsSplitterSide = exports.OnsPullHook = exports.OnsSwitch = exports.OnsTabbar = exports.OnsBackButton = exports.OnsNavigator = undefined;
	...
	Object.defineProperty(exports, 'OnsNavigator', {
		enumerable: true,
		get: function get() {
			return _components.OnsNavigator;
		}
	});
	Object.defineProperty(exports, 'OnsBackButton', {
		enumerable: true,
		get: function get() {
			return _components.OnsBackButton;
		}
	});
	Object.defineProperty(exports, 'OnsTabbar', {
		enumerable: true,
		get: function get() {
			return _components.OnsTabbar;
		}
	});
	Object.defineProperty(exports, 'OnsSwitch', {
		enumerable: true,
		get: function get() {
			return _components.OnsSwitch;
		}
	});
	Object.defineProperty(exports, 'OnsPullHook', {
		enumerable: true,
		get: function get() {
			return _components.OnsPullHook;
		}
	});
	Object.defineProperty(exports, 'OnsSplitterSide', {
		enumerable: true,
		get: function get() {
			return _components.OnsSplitterSide;
		}
	});
	
	var _onsenui = __webpack_require__(85);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _OnsNavigator = __webpack_require__(37);
	
	var _OnsNavigator2 = _interopRequireDefault(_OnsNavigator);
	
	var _OnsBackButton = __webpack_require__(80);
	
	var _OnsBackButton2 = _interopRequireDefault(_OnsBackButton);
	
	var _OnsTabbar = __webpack_require__(83);
	
	var _OnsTabbar2 = _interopRequireDefault(_OnsTabbar);
	
	var _OnsSwitch = __webpack_require__(87);
	
	var _OnsSwitch2 = _interopRequireDefault(_OnsSwitch);
	
	var _OnsPullHook = __webpack_require__(90);
	
	var _OnsPullHook2 = _interopRequireDefault(_OnsPullHook);
	
	var _OnsSplitterSide = __webpack_require__(93);
	
	var _OnsSplitterSide2 = _interopRequireDefault(_OnsSplitterSide);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.OnsNavigator = _OnsNavigator2.default;
	exports.OnsBackButton = _OnsBackButton2.default;
	exports.OnsTabbar = _OnsTabbar2.default;
	exports.OnsSwitch = _OnsSwitch2.default;
	exports.OnsPullHook = _OnsPullHook2.default;
	exports.OnsSplitterSide = _OnsSplitterSide2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] src/components/OnsNavigator.vue: named exports in *.vue files are ignored.")}
	...
	exports.default = {
	  ...
	  methods: {
	    push: function push(_ref) {
	      ...
	      var options = (0, _objectWithoutProperties3.default)(_ref, ['component']);
	
	      if (this.isRunning) {
	        return;
	      }
	
	      this.pages = [].concat((0, _toConsumableArray3.default)(this.pages), [component]);
	      this.isRunning = true;
	      this.$els.navigator._pushPage(options).catch(noop).then(function () {
	    ...
	    pop: function pop() {
	      ...
	      var removePage = function removePage() {
	        _this2.pages = _this2.pages.slice(0, _this2.pages.length - 1);
	        return _promise2.default.resolve();
	      };
	
	      this.isRunning = true;
	      this.$els.navigator._popPage(options, removePage).catch(noop).then(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/OnsBackButton.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/OnsTabbar.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  data: function data() {
	    return {
	      isAndroid: _onsenui.platform.isAndroid()
	    };
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/OnsSwitch.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/OnsPullHook.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports) {
	...
	exports.default = {
	  ready: function ready() {
	    ...
	    el.addEventListener('changestate', function (_ref) {
	      var state = _ref.state;
	
	      _this.$emit('changestate', { state: state });
	    });
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/OnsSplitterSide.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports) {
	...
	exports.default = {
	  ...
	  watch: {
	    open: function open(shouldOpen) {
	      var isOpen = this.$el.isOpen;
	  ...
	  methods: {
	    onPreopen: function onPreopen(ev) {
	      this.$emit('preopen', ev);
	    },
	    onPostopen: function onPostopen(ev) {
	      this.$emit('postopen', ev);
	    },
	    onPreclose: function onPreclose(ev) {
	      this.$emit('preclose', ev);
	    },
	    onPostclose: function onPostclose(ev) {
