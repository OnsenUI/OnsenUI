<template>
  <v-ons-page>
    ...
    <v-ons-carousel fullscreen v-model:active-index="carouselIndex" swipeable auto-scroll overscrollable @postchange="log('postchange')" @refresh="log('refresh')" @overscroll="log('overscroll')">
